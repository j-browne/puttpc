...
impl PuttPc {
    ...
    fn controls(&self) -> Controls {
        ...
        match (instr, self.micro) {
            ...
            (Instruction::Ldav, 2) => Controls::INSTRUCTION_OUT | Controls::A_IN,
            (Instruction::Ldam, 2) => Controls::INSTRUCTION_OUT | Controls::RAM_ADDR_IN,
            (Instruction::Ldam, 3) => Controls::RAM_OUT | Controls::A_IN,
            (Instruction::Sta, 2) => Controls::INSTRUCTION_OUT | Controls::RAM_ADDR_IN,
            (Instruction::Sta, 3) => Controls::A_OUT | Controls::RAM_IN,
            (Instruction::Txb, 2) => Controls::A_OUT | Controls::B_IN,
            (Instruction::Add, 2) => Controls::INSTRUCTION_OUT | Controls::RAM_ADDR_IN,
            (Instruction::Add, 3) => Controls::RAM_OUT | Controls::B_IN,
            (Instruction::Add, 4) => Controls::ADDER_OUT | Controls::A_IN | Controls::FLAGS_IN,
            (Instruction::Sub, 2) => {
                Controls::INSTRUCTION_OUT | Controls::RAM_ADDR_IN | Controls::SUBTRACT
            }
            (Instruction::Sub, 3) => Controls::RAM_OUT | Controls::B_IN | Controls::SUBTRACT,
            (Instruction::Sub, 4) => {
                Controls::ADDER_OUT | Controls::A_IN | Controls::FLAGS_IN | Controls::SUBTRACT
            }
            (Instruction::Jmp, 2) => Controls::INSTRUCTION_OUT | Controls::JUMP,
            (Instruction::Jz, 2) => Controls::INSTRUCTION_OUT | Controls::JUMP_IF_ZERO,
            (Instruction::Jc, 2) => Controls::INSTRUCTION_OUT | Controls::JUMP_IF_CARRY,
            (Instruction::Out, 2) => Controls::A_OUT | Controls::OUTPUT_IN,
            (Instruction::Hlt, 2) => Controls::HALT,
            (_, _) => Controls::empty(),
        }
    }
}
